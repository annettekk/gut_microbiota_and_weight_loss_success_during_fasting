---
title: "Spearman_R_Ducarmon_and_Grundler"
...
```{r}
## For Ducarmon dataset, calculate Spearman correlation of each OTU counts with BMI_Change_Percent_adj

# 1. In regression_data dataframe, identify columns that start with "mOTU"
