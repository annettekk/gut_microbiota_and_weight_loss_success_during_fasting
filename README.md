...
1. Stepwise_regression_Ducarmon.Rmd
2. Testing_stepwise_regression_model_on_Grundler_dataset.Rmd
3. Bray_dissimilarity_Ducarmon_and_Grundler.Rmd
4. Spearman_R_Ducarmon_and_Grundler.Rmd
5. CaZymes_Ducarmon.Rmd
