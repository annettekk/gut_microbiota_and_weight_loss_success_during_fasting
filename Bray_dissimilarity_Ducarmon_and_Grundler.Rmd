...
regression_data_filtered <- regression_data[!(rownames(regression_data) %in% c("71", "73")), ]
...
regression_data_g_filtered <- regression_data_g[!(rownames(regression_data_g) %in% c("27", "47", "59", "64")), ]
...
#Exclusion of influential points decreased adjusted R^2 of the model from 9.3% to -0.02% while unadjusted R^2 dropped to 0.01. p-value increasing from 0.055 to 0.59.
